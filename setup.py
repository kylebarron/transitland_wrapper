...
setup(
    ...
    keywords='transitland_wrapper',
    name='transitland_wrapper',
    packages=find_packages(include=['transitland_wrapper', 'transitland_wrapper.*']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/kylebarron/transitland_wrapper',
    version='0.2.0',
    zip_safe=False,
)